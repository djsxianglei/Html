...
document.getElementById("goumai").addEventListener('click',function(event){
	event.preventDefault();
	goBuy();
},false)
document.getElementById("goumai2").addEventListener('click',function(event){
	event.preventDefault();
	goBuy2();
},false)
document.getElementById("goumai3").addEventListener('click',function(event){
	event.preventDefault();
	goBuy3();
},false)
document.getElementById("goumai4").addEventListener('click',function(event){
	event.preventDefault();
	goBuy4();
},false)
document.getElementById("goumai5").addEventListener('click',function(event){
	event.preventDefault();
	goBuy5();
},false)
document.getElementById("goumai6").addEventListener('click',function(event){
	event.preventDefault();
	goBuy6();
},false)
...
$(document).swipeLeft(function(){
	...
	last.row = now.row;
	last.col = now.col;
	if (last.row != 7) { now.row = last.row+1; now.col = 1; pageMove(towards.left);}	
})
...
//              bg_htm = "<img id='sound_image' src='images/pay.gif'>";
//              box_htm = "<div id='note_box' style='height:100px;width:44px;position:absolute;left:-20px;top:-80px'></div>";
//          }
//          else {
//              bg_htm = "<img id='sound_image' width='30px' src='images/pay.gif'>";
